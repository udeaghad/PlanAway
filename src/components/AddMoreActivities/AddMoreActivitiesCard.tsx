...
const AddMoreActivitiesCard = ({onLoad, onPlaceChanged, newActivity, setNewActivity, Autocomplete}:AddMoreActivitiesProps) => {
  return (
        <Box sx={{mt: "2rem"}}>
                  ...
                  <Draggable draggableId={item.location_id} index={index}>
                    {(provided) => (
                      <div ref={provided.innerRef} {...provided.draggableProps} {...provided.dragHandleProps}>
                        <Box sx={{display: "flex", justifyContent: "baseline", alignItems: "center"}}>
                          <Box>
